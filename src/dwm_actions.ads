...
package Dwm_Actions is
   ...
   procedure Focus_Mon (Argument : Dwm_Types.Arg);
   ...
   procedure Kill_Client (Argument : Dwm_Types.Arg);
   ...
   --  Argument is unused.
   procedure Resize_Mouse (Argument : Dwm_Types.Arg);
   ...
   procedure Set_Layout (Argument : Dwm_Types.Arg);
   ...
   --  non-tiling layout.
   procedure Set_Mfact (Argument : Dwm_Types.Arg);
   ...
   procedure Spawn (Argument : Dwm_Types.Arg);
   ...
   procedure Tag (Argument : Dwm_Types.Arg);
   ...
   procedure Toggle_Floating (Argument : Dwm_Types.Arg);
   ...
   procedure Toggle_Tag (Argument : Dwm_Types.Arg);
   ...
   --  (toggleview()).
   procedure Toggle_View (Argument : Dwm_Types.Arg);
   ...
   procedure View (Argument : Dwm_Types.Arg);
   ...
   procedure Zoom (Argument : Dwm_Types.Arg);
